...
![Shows a pop-up that allows you to choose the game version, platform to download the plugin or install it with the Modrinth app.](/images/Installingvoicemod10.png)
