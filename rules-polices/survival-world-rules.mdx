...
- **No griefing** - do not destroy, steal or alter another players builds without permission
...
- **No stealing**- Items in chest, barrels, or shulker boxes belong to their owner unless given or traded
...
- **Spawns must be appropriate** - any offensive builds will be removed and is a banable offence